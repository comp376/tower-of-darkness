...
namespace tower_of_darkness_xna {
    class OldNPC {//: Object{
        ...
        //public OldNPC(Texture2D spriteSheet, int xNumberOfFrames, int yNumberOfFrames, int spriteWidth, int spriteHeight, Vector2 objectPosition, SpriteEffects walkingDirection, float directionInterval, SpriteFont font, string text)
