...
namespace tower_of_darkness_xna {
    class OldCharacter {//: Object {
        ...
        //public OldCharacter(Texture2D spriteSheet, int xNumberOfFrames, int yNumberOfFrames, int spriteWidth, int spriteHeight, Vector2 objectPosition, Texture2D lightTexture, float ambient, Color ambientColor, Texture2D lanternTexture, GraphicsDeviceManager graphics)
        ...
        //public bool Collides(OldNPC npc)
        //{
